...
public class EntryPortal extends javax.swing.JFrame {
	...
	private void initComponents() {
        ...
        label.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseClicked(MouseEvent e) {
        		JOptionPane.showMessageDialog(null, "JAIN University");
        	}
        });
        Image img=new ImageIcon(this.getClass().getResource("/jain-logo.png")).getImage();
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	try {
            ...
            if (isLoginSuccess) {
                ...
                {
                Teacher f2 = new Teacher(userid.getText());
                f2.setVisible(true);
                dispose();
                }
            } else {
